...
<div class="container">
	...
	<frm:form modelAttribute="empFrm">
		<table class="table table-responsive " bgcolor="cyan">
			<tr>
				<td>Employee name ::</td>
				<td><frm:input path="ename" /> <frm:errors
						cssClass="text-danger" path="ename" /></td>
			</tr>
			<tr>
				<td>Employee desg ::</td>
				<td><frm:input path="job" /> <frm:errors cssClass="text-danger"
						path="job" /></td>
			</tr>
			<tr>
				<td>Employee salary ::</td>
				<td><frm:input path="sal" /> <frm:errors cssClass="text-danger"
						path="sal" /></td>
			</tr>
			<tr>

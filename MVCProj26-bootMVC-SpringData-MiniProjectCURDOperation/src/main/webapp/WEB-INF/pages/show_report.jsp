...
<div class="container">
			...
			<table class="table table-bordered  table-secondary">
				...
				<c:forEach var="dto" items="${empsInfo}">
					<tr class="table-danger">
						...
						<td><b><h5 style="text-align: center">${dto.grossSalary}
								</h5></b></td>
						<td><b><h5 style="text-align: center">${dto.netSalary}
								</h5></b></td>
						<td><b><h5 style="text-align: center">${dto.deptNo}
								</h5></b></td>

						<td><a href="editEmp.htm?empNo=${dto.empNo}"><img
								src="images/edit.png" width="70" height="70" /></a> <a
							href="deleteEmp.htm?eno=${dto.empNo}"
							onclick="return confirm('are you sure you want to delete this record ')"><img
								src="images/delete.png" width="70" height="70" /></a></td>
					</tr>
				</c:forEach>
			</table>
		</c:when>
	...
	<c:if test="${resultMsg ne null && !empty resultMsg}">
		<marquee direction="right">
			<h1 class="text-primary font-weight-bold">${resultMsg}</h1>
		</marquee>
	</c:if>
	<br>
	<br>
	<h2>
		<a href="saveEmp.htm"><img src="images/save.jpg" width="100"
			height="100" /></a> &nbsp; &nbsp;<a href="welcome.htm"><img
			src="images/home.png" width="100" height="100" /></a> &nbsp; &nbsp;<a
			href="JavaScript:doPrint()"><img src="images/print.jpg"
